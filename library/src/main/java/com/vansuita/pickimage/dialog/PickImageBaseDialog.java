...
public abstract class PickImageBaseDialog extends DialogFragment implements IPickClick {
    ...
    static final String SETUP_TAG = "SETUP_TAG";
    private static final String RESOLVER_STATE_TAG = "resolverState";
    static final String DIALOG_FRAGMENT_TAG = PickImageBaseDialog.class.getSimpleName();
    ...
    private void onInitialize(Bundle savedInstanceState) {
    ...
    PickImageBaseDialog setOnPickResult(IPickResult onPickResult) {
        this.onPickResult = onPickResult;
        return this;
    }


    PickImageBaseDialog setOnClick(IPickClick onClick) {
        this.onClick = onClick;
        return this;
    }


    PickImageBaseDialog setOnPickCancel(IPickCancel onPickCancel) {
        this.onPickCancel = onPickCancel;
        return this;
    }


    AsyncImageResult getAsyncResult() {
