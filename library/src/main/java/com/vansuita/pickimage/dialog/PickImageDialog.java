...
public class PickImageDialog extends PickImageBaseDialog {
    ...
    private static PickImageDialog newInstance(PickSetup setup) {
    ...
    private static PickImageDialog build(PickSetup setup, IPickResult pickResult) {
    ...
    private static PickImageDialog build() {
        return build();
    }
